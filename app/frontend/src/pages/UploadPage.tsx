...
export function UploadPage({
  ...
  return (
    <div className="scale-[0.95] max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row md:space-x-8">
        {/* Progress Steps - Vertical Layout for Mobile */}
        <div className="md:w-1/4 mb-6 md:mb-0">
          <div className="space-y-4">
            {state.steps.map((step, index) => (
              <div key={index} className={`flex items-center space-x-3 ${state.currentStep === index ? 'text-green-600' : 'text-gray-500'}`}>
                <div className={`w-6 h-6 rounded-full border-2 ${state.currentStep === index ? 'border-green-600' : 'border-gray-300'}`}>
